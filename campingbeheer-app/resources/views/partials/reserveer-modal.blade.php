    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form id="booking-form" class="p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" id="guest-search" autocomplete="off" placeholder="Typ een naam om te zoeken..."
                    class="w-full rounded-lg border border-border px-3 py-2 text-sm focus:ring-2 focus:ring-accent/30 focus:border-accent outline-none">
                <div id="guest-search-results" class="hidden mt-1 rounded-lg border border-border bg-white shadow-lg max-h-48 overflow-y-auto text-sm"></div>
            </div>
            @endif
            ...
            <div id="booking-error" class="hidden text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg px-3 py-2"></div>
